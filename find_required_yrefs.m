...
x_targets      = [54, 350, 550, 711, 1000, 1150];      % mm 350, 550, 711, 1000
ydelta_targets = [0.02, 0.04, 0.05, 0.1, 0.5, 0.8];

blSweepFile = ['C:\Users\ak1u24\OneDrive - University of Southampton\MATLAB\Experimental Campaign 1\PIV\PIV_results\Case6_PIVresults\blSweep_20260421_082649.mat'];
...
for iYd = 1:nYd
    for iX = 1:nX
        if isfinite(delta_at_xtarget(iX))
            required_yref(iYd, iX) = ydelta_targets(iYd) * ...
                delta_at_xtarget(iX);
        end
    end
end
